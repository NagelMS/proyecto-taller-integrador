...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\linewidth]{fig/presupuesto.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\linewidth]{fig/Gantt-1.jpeg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\linewidth]{fig/Gantt-2.jpeg}
