...
Se actualizó el recurso gráfico mostrado en la pantalla para que el ícono sea semánticamente consistente con la aplicación (rastreo ganadero) como se observa en la Fig. \ref{fig:preeliminares.jpg}. Adicionalmente, se implementó una política de ahorro energético para la OLED: tras el encendido, el display permanece activo por 4 s y luego se desactiva de forma programada, se puede activar de nuevo tras presionar rápidamente el botón central del modulo.
...
Además, fue posible visualizar el rastreador en el mapa de APRS Track Direct, se puede observar parte de un recorrido simple realizado en el campus central de Tecnológico de Costa Rica, se puede denotar tambien la utilización de un animal como simbolo para el rastreador, con el fin de hacer alusión a la aplicación desarrollada.
