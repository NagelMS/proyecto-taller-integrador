...
void startupScreen(uint8_t index, const String& version) {
    ...
    displayShow(" LoRa APRS", "      (TRACKER)", workingFreq, "", "", "  TI0TEC2  " + version, 4000);
    logger.log(logging::LoggerLevel::LOGGER_LEVEL_INFO, "Main", "Grupo 2 (TI0TEC2) --> LoRa APRS Tracker/Station");
